...
/**
 * This class represents a joinable part of a label.
 */
public interface LabelJ extends TypeObject {
    /**
     * Is this label equivalent to bottom?
     * <p>
     * For example, a JoinLabelJ with no components would return true for this
     * method.
     */
    boolean isBottom();
     ...
     * <p>
     * For example, a JoinLabelJ with two components, one of which is Top, would
     ...
     */
    LabelJ subst(LabelSubstitution labelSubst) throws SemanticException;
     ...
     *            always be non-null.
     */
    boolean leq_(LabelJ L, LabelEnv H);
