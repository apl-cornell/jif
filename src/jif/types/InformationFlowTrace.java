...
public class InformationFlowTrace {
    ...
    public InformationFlowTrace(VarLabel l, Label from, Direction dir, LabelEquation e) {
        this.varlbl = l;
        this.equ = e;
        this.dir = dir;
        this.lblflows = from;
    ...
    public String toString () {
        ...
        return "Label "+lblflows.toString()+"flows "+dirstr + " variable " + varlbl.name() + " according to constraint" + equ.toString();
    }
}
